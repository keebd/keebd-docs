...
1. Ensure the keyboard is on.
   - When pressing the reset button, you should see the blue LED blink to indicate the controller is getting power.
...
3. If you're using a split keyboard, make sure you're pairing to the left half, the right half does not connect to your device.
   - See [Right Half Not Working](/troubleshooting/wireless/right-half-not-working) for more information.
