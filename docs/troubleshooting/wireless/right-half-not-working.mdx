...
If you have a working left half and a non-working right half, you likely have a pairing issue between the two halves. You'll want to read the [Split Halves Won't Connect](/troubleshooting/wireless/split-halves-wont-connect) guide to troubleshoot this issue.
